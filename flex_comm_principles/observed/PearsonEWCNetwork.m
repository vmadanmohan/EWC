% Function to infer communication between pairs of anatomically connected regions using the partial correlation, implemented as per the Event-marked Windowed Communication protocol
function [P,P_std] = PearsonEWCNetwork(data,SC,win,N,delay,sigevents)
    P = zeros(N,N);
    P_std = zeros(N,N);
